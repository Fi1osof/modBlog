...
class SocietyBlogCreateManagerController extends ResourceCreateManagerController {
    ...
    function getUrl(){
        return $this->modx->getOption('manager_url').'components/modblog/connectors/mgr/modsociety/societyblog/index.php';
    }
    
    
    function getDefaultTemplate(){
        return $this->modx->getOption('modblog.blog_default_template', null, $this->modx->getOption('default_template'));
