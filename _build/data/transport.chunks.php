...
$chunk->fromArray(array(
    ...
    'description' => '',
    'snippet' => file_get_contents($sources['source_core'].'/elements/chunks/BLOG_add_blog_tpl.tpl'),
    'properties' => '',
),'',true,true);
$chunks[] = $chunk;
...
$chunk->fromArray(array(
    ...
    'description' => '',
    'snippet' => file_get_contents($sources['source_core'].'/elements/chunks/BLOG_blogListTpl.tpl'),
    'properties' => '',
),'',true,true);
$chunks[] = $chunk;
